...
setup_whatsapp() {
  ...
  # Register as a system service automatically so the WhatsApp server
  # survives terminal closes and starts on boot without user intervention.
  info "  Registering WhatsApp server as a background service..."
